...
function Nav() {
  return (
    <nav
      className={`${Styles.glassmorph} w-11/12 h-16 md:w-3/4 lg:w-2/4 md:h-20  rounded-xl fixed left-1/2 top-6 transform -translate-x-2/4 flex items-center justify-center z-50`}
    >
